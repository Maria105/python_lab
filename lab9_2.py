...
def convert(your_number: float) -> str:
    ...
    numbers = {1: 'один', 2: 'два', 3: 'три', 4: 'чотири', 5: 'п\'ять', 
               ...
               60: 'шістдесят', 70: 'сімдесять', 80: 'вісімдесять', 
               90: 'дев\'яносто', 100: 'сто', 200: 'двісті', 300: 'триста',
               400: 'чотириста', 500: 'п\'ятсот', 600: 'шістсот',
...
print(convert(float(input("Input your amount: "))))
