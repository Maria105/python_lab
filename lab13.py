...
class Employee(abc.ABC):
    """ This function create abstract methods"""
...
class HourlyEmployee(Employee):
    """ This function calculate different taxes for hourly employee """
...
class MonthlyEmployee(Employee):
    """ This function calculate different taxes for monthly employee """
...
class EntrepreneurEmployee(Employee):
    """This function calculate different taxes for Entrepreneur"""
...
class FreelancerEmployee(Employee):
    """ This function calculate different taxes for Freelancer """
...
def input_data() -> list:
    names = ('Masha', 'Dasha', 'Ira', 'Liuda', 'Andriy', 'Anna', 'Ivan')
    employees = []
